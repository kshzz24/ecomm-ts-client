...
const PieCharts = () => {
  ...
  // const { productCategories: categories, stockAvailability:stock, revenueDistribution: revenue, orderFullfillment:order, usersAgeGroup:ageGroup, adminCustomers  } = data?.charts!;
            ...
            <section>
              <div>
                <PieChart
                  ...
                  data={[order.processing, order.shipping, order.delivered]}
                  backgroundColor={[
                    `hsl(110,80%, 80%)`,
                    `hsl(110,80%, 50%)`,
                    `hsl(110,40%, 50%)`,
